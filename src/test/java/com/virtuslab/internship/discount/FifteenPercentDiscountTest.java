...
public class FifteenPercentDiscountTest {
    ...
    void shouldApplyDiscount() throws Exception {
        ...
        var expectedTotalPrice = cheese.price().add(steak.price()).add(bread.price().multiply(BigDecimal.valueOf(2))).add(cereals.price()).multiply(BigDecimal.valueOf(0.85));
    ...
    void shouldNotApplyDiscount() throws Exception {
        ...
        var discount = new FifteenPercentDiscount();
        var receiptAfterDiscount = discount.apply(receipt);
        var expectedTotalPrice = cheese.price().multiply(BigDecimal.valueOf(2)).add(cereals.price().multiply(BigDecimal.valueOf(2)));
